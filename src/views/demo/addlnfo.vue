    ...
    >
      <div class="basic-info">
        ...
        <el-form-item label="窗口数量" prop="count">
          <el-select v-model="dataForm.count" placeholder="请选择窗口数量" style="width:300px">
      ...
      <div class="service-info">
        ...
        <div class="week">
          ...
          <div class="content01">
            ...
            <div class="content-text">
              <el-row>
                ...
                <el-col :span="7">
                  ...
                  >
                    <el-select v-model="dataForm.List.num" placeholder="请选择预约人数" style="width:11vw">
                      <el-option label="1" value="1"></el-option>
                      <el-option label="2" value="2"></el-option>
                      <el-option label="3" value="3"></el-option>
                      <el-option label="4" value="4"></el-option>
            ...
            <div class="time-list">
              ...
              >
                <el-col :span="8" style="text-align:center;line-height:0.6rem;padding-left:1.5vw">
                  <el-time-select
                    placeholder="起始时间"
                ...
                <el-col :span="8" style="padding-left:1.5vw">
                  ...
                  >
                    <el-select v-model="item.maxPersonNum" placeholder="请选择预约人数" style="width:11vw">
                      <el-option label="1" value="1"></el-option>
                      <el-option label="2" value="2"></el-option>
                      <el-option label="3" value="3"></el-option>
                      <el-option label="4" value="4"></el-option>
                ...
                <el-col :span="8">
                  <el-link
                    ...
                    style="margin:0 auto;line-height:0.5rem;padding-left:1.5vw"
                  >删除</el-link>
                </el-col>
              </el-row>
            </div>
        ...
        <el-row style="margin-top:1rem">
          ...
          <el-col :span="18">
            <el-form-item label="预约到" prop="sorts">
        ...
        <el-row>
          ...
          <el-col :span="18">
            <el-form-item label="可提前" prop="sorts">
              <el-input v-model="dataForm.cancellationHoursAdvance" style="width:1rem"></el-input>
              <el-select v-model="dataForm.canceHours" style="width:1rem" placeholder="小时" disabled>
      ...
      <div>
        ...
        <el-button type="success" @click="submitForm('dataForm')">保存</el-button>
      </div>
    </el-form>
  </div>
</template>
...
export default {
  data() {
    return {
      ...
      rules: {
        ...
        count: [
          { required: true, message: "请选择窗口数量", trigger: "change" }
        ],
  ...
  mounted() {
    console.log(this.dataForm.timeList);
  ...
  methods: {
    ...
    update() {
      ...
      that
        .$http({
          url: that.$http.adornUrl("/ServiceProjectManagement/add"),
          method: "post",
      ...
      console.log(this.dataForm.sort);
    },
    fanhui() {
      this.$router.back(-1);
    }
